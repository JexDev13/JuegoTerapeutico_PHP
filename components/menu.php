...
<header style="height: 10vh; width:100%;">
    <nav class="navbar navbar-expand-lg navbar-light back-color-secondary w-100 h-100 font-berlin">
            ...
            <div class="collapse navbar-collapse justify-content-end font-impact" id="navbarNav">
                <ul class="navbar-nav w-15">
                    <li class="nav-item d-flex align-items-center flex-grow-1">
                        <a class="nav-link color-primary fs-4" href="../pages/paciente.php">Pacientes</a>
                    </li>
                    <li class="nav-item d-flex align-items-center flex-grow-1">
                        <a class="nav-link color-primary fs-4" href="../pages/estadisticasPaciente.php">Estadísticas</a>
                    </li>
                    <li class="nav-item d-flex align-items-center flex-grow-1">
                        <a class="nav-link color-primary fs-4" href="../pages/tableroJuegos.php">Juegos</a>
                    </li>
                    <li class="nav-item d-flex align-items-center flex-grow-1">
